...
namespace Prototype
{
    public class DmgReductionStatus : UnitStatus
    {
        ...
        public override bool Init(Unit unit)
        {
            ...
            unit.GetComponent<UnitHealth>().percentCallback = callback;
            return base.Init(unit);
        }

        public int DamageOverride(int amount) { return (amount - (int)(amount * reduction)) ; }
